        ...
        <script>            
            initializeButtons = function(){
                $('#search-btn').click(function(){
                    window.location = 'exptest12.html#visionSearch';
                });
                
                $('#sternberg-btn').click(function(){
                    window.location = 'sternberg3.html#sternberg';
                });
                
                $('#stroop-btn').click(function(){
                    window.location = 'circ_exp_new_WRAPPED.html#stroop';
                });
                
                $('#density-btn').click(function(){
                    window.location = 'patterndensity2.html#density';
                });
...
<?php include('navbar.html'); ?>
            <div class='module_type1 span8'>
                ...
                <div class='tab-content'>
                    ...
                    <img src='bootstrap/img/hom.gif' alt='About Location' style='float: right'>
                    ...
                    <img src='bootstrap/img/visualsearch.png' alt='About Location' style='float: right'>
                    ...
                    <p> To practice the task and see how it works, click the "Try it" button below.  By default you should press "F" when the target is present and "J" when the target is not present. Press the space bar to start each new trial.  Try to go as quickly as you can without making more than a couple mistakes. </p>
                        ...
                        <a href="vision_search.php#visionSearch" class='btn btn-primary tryit'>Try it!</a>
                    </div>
                    ...
                    <img src='bootstrap/img/sternberg.png' alt='About Location' style='float: left'>
                    ...
                    <img src='bootstrap/img/reversestroop.png' alt='About Location' style='float: right'>
