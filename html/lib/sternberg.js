        ...
        timer = setInterval(function(){
            ...
            //if the list is done:
                ...
                $('.listDisplay').remove(); //clear the experiment box
                    $('#experiment').append('<div class="listDisplay cross" style="text-align:center;"> + </div>') //screen to get ready
                ...
                setTimeout(function(){
                    ...
                    //display the probe
                    $('#experiment').append('<div class="listDisplay" style="text-align:center;">' + global.trials[t].test[1] + '</div>') 
        ...
        $(document).keydown(function (e) {
            ...
            if (typeof select != 'undefined'){ 
                ...
                if ((code == 70 || code == 74) && select==false) { 
                    ...
                    experimentControls.updateFooter("Press the enter key when finished");
